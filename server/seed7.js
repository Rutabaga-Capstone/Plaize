  ...
  .mutate({
    mutation: gql`
      mutation {
        ...
        pin1: CreatePin(id: 9, lat: 41.895506, lng: -87.639014) {
          id
          lat
          lng
        }
        pin2: CreatePin(id: 21, lat: 41.896461, lng: -87.641228) {
          id
          lat
          lng
        }
        ...
        pin4: CreatePin(id: 22, lat: 41.895060, lng: -87.639914) {
          id
          lat
          lng
        }
        ...
        pin6: CreatePin(id: 24, lat: 41.896506, lng: -87.632014) {
          id
          lat
          lng
        }
        up1: AddUserPlants(from: {id: 18}, to: {id: 14}) {
          from {
            name
          }
          to {
        ...
        upin1: AddUserPins(from: {id: 8}, to: {id: 4}) {
          from {
            name
          }
          to {
        ...
        up2: AddUserPlants(from: {id: 24}, to: {id: 14}) {
          from {
            name
          }
          to {
        ...
        upin2: AddUserPins(from: {id: 22}, to: {id: 18}) {
          from {
            name
          }
          to {
        ...
        pp2: AddPinPlants(from: {id: 22}, to: {id: 22}) {
          from {
            lat
            lng
          }
        ...
        up3: AddUserPlants(from: {id: 19}, to: {id: 7}) {
          from {
            name
          }
          to {
        ...
        upin3: AddUserPins(from: {id: 19}, to: {id: 9}) {
          from {
            name
          }
          to {
        ...
        pp3: AddPinPlants(from: {id: 19}, to: {id: 21}) {
          from {
            lat
            lng
          }
        ...
        up4: AddUserPlants(from: {id: 19}, to: {id: 5}) {
          from {
            name
          }
          to {
        ...
        upin4: AddUserPins(from: {id: 25}, to: {id: 22}) {
          from {
            name
          }
          to {
        ...
        pp4: AddPinPlants(from: {id: 24}, to: {id: 5}) {
          from {
            lat
            lng
          }
        ...
        up5: AddUserPlants(from: {id: 19}, to: {id: 5}) {
          from {
            name
          }
          to {
        ...
        upin5: AddUserPins(from: {id: 4}, to: {id: 13}) {
          from {
            name
          }
          to {
        ...
        pp5: AddPinPlants(from: {id: 4}, to: {id: 1}) {
          from {
            lat
            lng
          }
        ...
        up6: AddUserPlants(from: {id: 23}, to: {id: 9}) {
          from {
            name
          }
          to {
        ...
        upin6: AddUserPins(from: {id: 23}, to: {id: 21}) {
          from {
            name
          }
          to {
        ...
        pp6: AddPinPlants(from: {id: 3}, to: {id: 13}) {
          from {
            lat
            lng
          }
