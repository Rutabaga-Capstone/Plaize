  ...
  .mutate({
    mutation: gql`
      mutation {
        ...
        up1: AddUserPlants(from: {id: 23}, to: {id: 3}) {
          from {
            name
          }
          to {
        ...
        upin1: AddUserPins(from: {id: 12}, to: {id: 20}) {
          from {
            name
          }
          to {
        ...
        pp1: AddPinPlants(from: {id: 8}, to: {id: 19}) {
          from {
            lat
            lng
          }
        ...
        up2: AddUserPlants(from: {id: 7}, to: {id: 13}) {
          from {
            name
          }
          to {
        ...
        upin2: AddUserPins(from: {id: 22}, to: {id: 1}) {
          from {
            name
          }
          to {
        ...
        pp2: AddPinPlants(from: {id: 11}, to: {id: 1}) {
          from {
            lat
            lng
          }
        ...
        up3: AddUserPlants(from: {id: 24}, to: {id: 19}) {
          from {
            name
          }
          to {
        ...
        upin3: AddUserPins(from: {id: 18}, to: {id: 17}) {
          from {
            name
          }
          to {
        ...
        pp3: AddPinPlants(from: {id: 23}, to: {id: 1}) {
          from {
            lat
            lng
          }
        ...
        up4: AddUserPlants(from: {id: 1}, to: {id: 8}) {
          from {
            name
          }
          to {
        ...
        upin4: AddUserPins(from: {id: 21}, to: {id: 5}) {
          from {
            name
          }
          to {
        ...
        pp4: AddPinPlants(from: {id: 4}, to: {id: 23}) {
          from {
            lat
            lng
          }
        ...
        up5: AddUserPlants(from: {id: 23}, to: {id: 12}) {
          from {
            name
          }
          to {
        ...
        upin5: AddUserPins(from: {id: 1}, to: {id: 22}) {
          from {
            name
          }
          to {
        ...
        pp5: AddPinPlants(from: {id: 19}, to: {id: 9}) {
          from {
            lat
            lng
          }
        ...
        up6: AddUserPlants(from: {id: 20}, to: {id: 5}) {
          from {
            name
          }
          to {
        ...
        upin6: AddUserPins(from: {id: 14}, to: {id: 10}) {
          from {
            name
          }
          to {
        ...
        pp6: AddPinPlants(from: {id: 18}, to: {id: 16}) {
          from {
            lat
            lng
          }
