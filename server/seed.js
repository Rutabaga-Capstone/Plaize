module.exports = `
  ...
  pin1:CreatePin( id: 1 lat: 41.895506 lng: -87.639014 ) { id lat lng }
  pin2:CreatePin( id: 2 lat: 41.896461 lng: -87.641228 ) { id lat lng }
  pin3:CreatePin( id: 3 lat: 41.895506 lng: -87.639014 ) { id lat lng }
  pin4:CreatePin( id: 4 lat: 41.895060 lng: -87.639914 ) { id lat lng }
  pin5:CreatePin( id: 5 lat: 41.897461 lng: -87.641328 ) { id lat lng }
  pin6:CreatePin( id: 6 lat: 41.896506 lng: -87.632014 ) { id lat lng }
