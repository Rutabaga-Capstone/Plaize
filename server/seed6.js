  ...
  .mutate({
    mutation: gql`
      mutation {
        ...
        pin1: CreatePin(id: 20, lat: 41.895506, lng: -87.639014) {
          id
          lat
          lng
        }
        ...
        pin3: CreatePin(id: 4, lat: 41.895506, lng: -87.639014) {
          id
          lat
          lng
        }
        ...
        pin5: CreatePin(id: 21, lat: 41.897461, lng: -87.641328) {
          id
          lat
          lng
        }
        pin6: CreatePin(id: 9, lat: 41.896506, lng: -87.632014) {
          id
          lat
          lng
        }
        up1: AddUserPlants(from: {id: 19}, to: {id: 23}) {
          from {
            name
          }
          to {
        ...
        upin1: AddUserPins(from: {id: 6}, to: {id: 6}) {
          from {
            name
          }
          to {
        ...
        pp1: AddPinPlants(from: {id: 9}, to: {id: 22}) {
          from {
            lat
            lng
          }
        ...
        up2: AddUserPlants(from: {id: 3}, to: {id: 4}) {
          from {
            name
          }
          to {
        ...
        upin2: AddUserPins(from: {id: 6}, to: {id: 23}) {
          from {
            name
          }
          to {
        ...
        pp2: AddPinPlants(from: {id: 18}, to: {id: 23}) {
          from {
            lat
            lng
          }
        ...
        up3: AddUserPlants(from: {id: 1}, to: {id: 22}) {
          from {
            name
          }
          to {
        ...
        upin3: AddUserPins(from: {id: 24}, to: {id: 22}) {
          from {
            name
          }
          to {
        ...
        pp3: AddPinPlants(from: {id: 2}, to: {id: 6}) {
          from {
            lat
            lng
          }
        ...
        up4: AddUserPlants(from: {id: 20}, to: {id: 6}) {
          from {
            name
          }
          to {
        ...
        upin4: AddUserPins(from: {id: 2}, to: {id: 24}) {
          from {
            name
          }
          to {
        ...
        pp4: AddPinPlants(from: {id: 7}, to: {id: 19}) {
          from {
            lat
            lng
          }
        ...
        up5: AddUserPlants(from: {id: 6}, to: {id: 1}) {
          from {
            name
          }
          to {
        ...
        upin5: AddUserPins(from: {id: 24}, to: {id: 3}) {
          from {
            name
          }
          to {
        ...
        pp5: AddPinPlants(from: {id: 20}, to: {id: 2}) {
          from {
            lat
            lng
          }
        ...
        up6: AddUserPlants(from: {id: 24}, to: {id: 22}) {
          from {
            name
          }
          to {
        ...
        upin6: AddUserPins(from: {id: 15}, to: {id: 14}) {
          from {
            name
          }
          to {
        ...
        pp6: AddPinPlants(from: {id: 15}, to: {id: 14}) {
          from {
            lat
            lng
          }
