  ...
  .mutate({
    mutation: gql`
      mutation {
        ...
        pin1: CreatePin(id: 5, lat: 41.895506, lng: -87.639014) {
          id
          lat
          lng
        }
        pin2: CreatePin(id: 17, lat: 41.896461, lng: -87.641228) {
          id
          lat
          lng
        }
        pin3: CreatePin(id: 19, lat: 41.895506, lng: -87.639014) {
          id
          lat
          lng
        }
        ...
        pin6: CreatePin(id: 8, lat: 41.896506, lng: -87.632014) {
          id
          lat
          lng
        }
        up1: AddUserPlants(from: {id: 8}, to: {id: 5}) {
          from {
            name
          }
          to {
        ...
        upin1: AddUserPins(from: {id: 22}, to: {id: 20}) {
          from {
            name
          }
          to {
        ...
        pp1: AddPinPlants(from: {id: 15}, to: {id: 5}) {
          from {
            lat
            lng
          }
        ...
        up2: AddUserPlants(from: {id: 16}, to: {id: 7}) {
          from {
            name
          }
          to {
        ...
        upin2: AddUserPins(from: {id: 5}, to: {id: 19}) {
          from {
            name
          }
          to {
        ...
        pp2: AddPinPlants(from: {id: 20}, to: {id: 16}) {
          from {
            lat
            lng
          }
        ...
        up3: AddUserPlants(from: {id: 12}, to: {id: 2}) {
          from {
            name
          }
          to {
        ...
        upin3: AddUserPins(from: {id: 19}, to: {id: 13}) {
          from {
            name
          }
          to {
        ...
        pp3: AddPinPlants(from: {id: 22}, to: {id: 10}) {
          from {
            lat
            lng
          }
        ...
        up4: AddUserPlants(from: {id: 8}, to: {id: 22}) {
          from {
            name
          }
          to {
        ...
        upin4: AddUserPins(from: {id: 4}, to: {id: 13}) {
          from {
            name
          }
          to {
        ...
        pp4: AddPinPlants(from: {id: 11}, to: {id: 19}) {
          from {
            lat
            lng
          }
        ...
        up5: AddUserPlants(from: {id: 25}, to: {id: 18}) {
          from {
            name
          }
          to {
        ...
        upin5: AddUserPins(from: {id: 20}, to: {id: 17}) {
          from {
            name
          }
          to {
        ...
        pp5: AddPinPlants(from: {id: 7}, to: {id: 5}) {
          from {
            lat
            lng
          }
        ...
        up6: AddUserPlants(from: {id: 1}, to: {id: 24}) {
          from {
            name
          }
          to {
        ...
        upin6: AddUserPins(from: {id: 7}, to: {id: 21}) {
          from {
            name
          }
          to {
        ...
        pp6: AddPinPlants(from: {id: 1}, to: {id: 20}) {
          from {
            lat
            lng
          }
