  ...
  .mutate({
    mutation: gql`
      mutation {
        ...
        pin1: CreatePin(id: 18, lat: 41.895506, lng: -87.639014) {
          id
          lat
          lng
        }
        ...
        pin6: CreatePin(id: 3, lat: 41.896506, lng: -87.632014) {
          id
          lat
          lng
        }
        up1: AddUserPlants(from: {id: 16}, to: {id: 16}) {
          from {
            name
          }
          to {
        ...
        upin1: AddUserPins(from: {id: 5}, to: {id: 16}) {
          from {
            name
          }
          to {
        ...
        pp1: AddPinPlants(from: {id: 6}, to: {id: 3}) {
          from {
            lat
            lng
          }
        ...
        up2: AddUserPlants(from: {id: 17}, to: {id: 18}) {
          from {
            name
          }
          to {
        ...
        upin2: AddUserPins(from: {id: 22}, to: {id: 11}) {
          from {
            name
          }
          to {
        ...
        pp2: AddPinPlants(from: {id: 24}, to: {id: 18}) {
          from {
            lat
            lng
          }
        ...
        up3: AddUserPlants(from: {id: 2}, to: {id: 5}) {
          from {
            name
          }
          to {
        ...
        upin3: AddUserPins(from: {id: 17}, to: {id: 23}) {
          from {
            name
          }
          to {
        ...
        pp3: AddPinPlants(from: {id: 10}, to: {id: 9}) {
          from {
            lat
            lng
          }
        ...
        up4: AddUserPlants(from: {id: 24}, to: {id: 6}) {
          from {
            name
          }
          to {
        ...
        upin4: AddUserPins(from: {id: 14}, to: {id: 4}) {
          from {
            name
          }
          to {
        ...
        pp4: AddPinPlants(from: {id: 20}, to: {id: 22}) {
          from {
            lat
            lng
          }
        ...
        up5: AddUserPlants(from: {id: 14}, to: {id: 12}) {
          from {
            name
          }
          to {
        ...
        upin5: AddUserPins(from: {id: 13}, to: {id: 5}) {
          from {
            name
          }
          to {
        ...
        pp5: AddPinPlants(from: {id: 6}, to: {id: 5}) {
          from {
            lat
            lng
          }
        ...
        up6: AddUserPlants(from: {id: 8}, to: {id: 9}) {
          from {
            name
          }
          to {
        ...
        upin6: AddUserPins(from: {id: 12}, to: {id: 12}) {
          from {
            name
          }
          to {
        ...
        pp6: AddPinPlants(from: {id: 2}, to: {id: 14}) {
          from {
            lat
            lng
          }
